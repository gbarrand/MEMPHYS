...
MEMPHYS::SteppingAction::SteppingAction() {
}//Ctor
...
void MEMPHYS::SteppingAction::UserSteppingAction(const G4Step * theStep){
  ...
  if(particleType==G4OpticalPhoton::OpticalPhotonDefinition()){
	...
	//	G4cout << "(JEC) UserSteppingAction: INFO : process <"<<i << "/" << nprocesses << ">: " << (*pv)[i]->GetProcessName()  << G4endl;
